public class NQueensIterativeNineFirstSolution {
    ...
    public static boolean nQueen(int[][] board, int row)  { //method that uses the iterative format combined with backtracking to place the queens on the board
        ...
        //the for loops go from index i to i8 to get NQueen solutions for 9x9
                                                                ...
                                                                for (int i7 = 0; i7 < board.length; i7++) {
                                                                    ...
                                                                    if (canPlaceQueen(board, row+7, i7)) {
                                                                        ...
                                                                        for (int i8 = 0; i8 < board.length; i8++) {
                                                                            ...
                                                                            if (canPlaceQueen(board, row+8, i8)) {
    ...
    public static void main(String[] args) {
        ...
        final int boardDimension = 9; // holds a constant value of 9 please do not change this value as it may cause an index Error or return false
